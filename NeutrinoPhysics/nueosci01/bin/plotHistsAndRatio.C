...
TCanvas* plotHistsAndRatio(TH1F* numeratorHist, TH1F* denominatorHist, 
                           TString title, TString xTitle, TString yTitle);

TCanvas* plotHistsAndRatio(TH1F* numeratorHist1, TH1F* numeratorHist2, TH1F* denominatorHist, 
                           TString title, TString xTitle, TString yTitle);

TCanvas* plotHistsAndRatio(TH1F* numeratorHist1, TH1F* numeratorHist2, TH1F* numeratorHist3, TH1F* denominatorHist, 
                           TString title, TString xTitle, TString yTitle);

TCanvas* plotHistsAndRatio(vector<TH1F*> numeratorHistograms, TH1F* denominatorHist, 
                           TString title, TString xTitle, TString yTitle);
...
TCanvas* plotHistsAndRatio(vector<TH1F*> numeratorHistograms, TH1F* denominatorHist, 
  ...
  hist_over_denomHist[0]->SetMarkerStyle(1);
  hist_over_denomHist[0]->SetLineWidth(1);
  hist_over_denomHist[0]->SetLineColor(kBlue);
  ...
  hist_over_denomHist[0]->GetXaxis()->CenterTitle(true);
  hist_over_denomHist[0]->GetYaxis()->CenterTitle(true);
  hist_over_denomHist[0]->GetYaxis()->SetTitleFont(42);
  ...
  for (int i=1; i<numberOfNumeratorHists; i++) {
    ...
    hist_over_denomHist[i]->SetMarkerStyle(1);
    hist_over_denomHist[i]->Draw("esame");
  }
  // End bottom plot
  //*************************************************
  ...
  denominatorHistogram->GetXaxis()->CenterTitle(true);
  denominatorHistogram->GetYaxis()->CenterTitle(true);
  ...
  denominatorHistogram->GetYaxis()->SetTitleOffset(0.53);
  denominatorHistogram->SetTitle(title+";;"+yTitle);
  denominatorHistogram->GetYaxis()->SetTitleFont(42);
  denominatorHistogram->GetYaxis()->SetNdivisions(509);
  denominatorHistogram->SetMinimum(topYmin);
  denominatorHistogram->SetMaximum(topYmax);
